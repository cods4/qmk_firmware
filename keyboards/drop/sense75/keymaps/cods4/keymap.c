...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        RM_TOGG, RM_NEXT, RM_VALU, RM_SPDU, RM_HUEU, RM_SATU, _______, _______, _______, _______, _______, _______, _______, _______,          KC_HOME,
        _______, RM_PREV, RM_VALD, RM_SPDD, RM_HUED, RM_SATD, _______, _______, _______, _______, _______, _______,          _______,          KC_END,
        _______,          _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______,          _______, _______,
        MO(2),   GU_TOGG, _______,                            EE_CLR,                             _______,  _______, _______, _______, _______, _______
    ),
    [2] = LAYOUT(
